...
def handle_s02_30_draft_ordered_phases_and_tasks_via_generator_model_call(
    ...
    system_prompt = (
        ...
        "real rollback_trigger/rollback_deadline_seconds. Task files must use "
        "exact strings from 'Allowed existing repository paths' unless "
        "proposed_creation=true and the task explicitly creates a new file. "
