"""Production handlers for the S01 (Rank & Select) shared-workflow stage.
...
build_s01_registrations = _shared.build_s01_registrations
build_s01_runtime = _shared.build_s01_runtime
